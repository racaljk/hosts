...
* 如果您使用了本项目，则您在使用本项目的产品(包括但不限于其衍生产品)过程中产生的法律问题和安全问题，与本项目无关。本项目不承担任何连带法律责任。
* 使用/下载本项目中的产品(包括但不限于其衍生产品)则意味着您已经阅读了本协议并愿意遵守本协议规定的有关事项；如果您违反本协议使用/下载项目中的产品(包括但不限于其衍生产品)，我们将追究您的违约责任。
* 项目中有规定其他协议的，也适用于本条协议的前一条协议。
